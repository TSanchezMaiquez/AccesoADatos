...
public class NativeSQLTest {
    ...
    void findAllTest() {
        ...
        //OJO: poner el nombre de la tabla, NO de la entity
...
//        employees.forEach(e -> System.out.println(e[0] + " " + e[1] + " " + e[2]));
    ...
    void addScalarTest() {
        ...
        List<Tuple> employees = session.createNativeQuery(sql, Tuple.class)
                //Aunque no es necesario, es recomendable ponerle de que tipo es cada uno de los campos
                //para ayudar con el mapeo
    ...
    void namedNativeTuple() {
        insertData();
        Session session = HibernateUtil.getSessionFactory().openSession();
        //"namedNativeTuple" -> consulta nombrada. Se ha creado en la entity Employee
