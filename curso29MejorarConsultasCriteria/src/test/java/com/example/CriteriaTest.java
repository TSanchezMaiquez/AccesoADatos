...
public class CriteriaTest {
    ...
    void projectionOneColumn() {
        ...
        /*Como vamos a recuperar una unica columna podemos poner el tipo de esa columna y no la clase a la que
        * pertenece. email es tipo String por eso elegimos String, si fuera saldo seria Double*/
    ...
    void orderBy() {
        ...
        /*IMPORTANTE: Si quieres ordenar por un campo calculado, debes crear una variable donde guardar el calculo para
        * poder utilizarla posteriormente en el orderBy*/
        var avgSalary = builder.avg(root.get("salary")); //<- variable que guarda la media de salarios
        query.multiselect(
                root.get("city"),
                avgSalary,
                builder.avg(root.get("bonus"))
        ...
        query.groupBy(root.get("city"));
        query.orderBy(builder.desc(avgSalary)); //<- utilizamos la variable en el orderBy y ordenamos pro este campo
    ...
    void joinFetch() {
        ...
        /*LEFT: Te trae todos los autores, tengan o no tengan libros
        * INNER: Solo te trae los autores que tienen libros*/
